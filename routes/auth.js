// ROUTES file: auth.js
// fetch requests from Auth.js (frontend) come here
...
router.post('/signin', (req, res) => {
  ...
  // catch error (in instance of problem finding our user in - Step 2.)
  .catch(err => {
    console.log(err)
    res.status(500).json({
...
// GET /validate --------------------------------------
  /* validate the JSON webtoken sent to the backend:
  (Will happen every time someone is trying to request data */
